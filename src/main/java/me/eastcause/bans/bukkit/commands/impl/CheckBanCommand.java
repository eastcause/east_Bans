...
public class CheckBanCommand extends BukkitCmd {
    public CheckBanCommand() {
        super("checkban");
        setDescription("Checkban player");
        setUsage("/checkban <nick> <server ? server=serverName>");
    }
